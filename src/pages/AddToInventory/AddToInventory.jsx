...
const AddPC = () => {
  const [steps, setSteps] = useState([
    { id: '01', name: 'Type of Inventory', description: 'Select what type of inventory you want to add', href: '#', status: 'complete' },
  { id: '02', name: 'Category of inventory', description: 'Select subcategory', href: '#', status: 'complete' },
  { id: '03', name: 'Info', description: 'Fill up informations', href: '#', status: 'current' }
  ])
  // type of inventory to put into appropriete collection
  const [selectedType, setSelectedType] = useState(avaiableInventoryTypes[0])
  return (
    <>
